package net.mcreator.opmobsoptools.client.model;
...
public class Modelwolfnew extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("op_mobs_op_tools", "modelwolfnew"), "main");
	...
	public Modelwolfnew(ModelPart root) {
		super(root);
