package net.mcreator.opmobsoptools;
...
import net.mcreator.opmobsoptools.init.OpMobsOpToolsModTabs;
import net.mcreator.opmobsoptools.init.OpMobsOpToolsModSounds;
...
public class OpMobsOpToolsMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(OpMobsOpToolsMod.class);
	public static final String MODID = "op_mobs_op_tools";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing OpMobsOpToolsMod");
		OpMobsOpToolsModSounds.load();
		OpMobsOpToolsModTabs.load();
		OpMobsOpToolsModEntities.load();
		OpMobsOpToolsModItems.load();
		tick();
