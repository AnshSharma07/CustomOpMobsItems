...
public class MythicWolfEntity extends Monster {
	...
	public MythicWolfEntity(EntityType<MythicWolfEntity> type, Level world) {
		super(type, world);
		xpReward = 150;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.wolf_angry.growl"));
	}
